...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Turn the Week 5 Stage 1 crypto panel into a wide adjusted-price matrix "
            "and a wide daily-return matrix."
        ),
    )
    parser.add_argument(
        "--input-path",
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("Week 5 Stage 2: wide adjusted prices and returns")
    print()
